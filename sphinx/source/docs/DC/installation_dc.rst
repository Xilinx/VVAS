...
Installation
###########################
This section covers the detailed steps to install various IVAS dependencies for various platforms. Installation process is splitted into hardware installation and software installation.

************************************************
Software Installation
************************************************

This section covers installatiion of various software dependencies for the IVAS framework.
...
#. Unzip the package. Following is the content of th epackage

     - aws.xclbin: IVAS AWS specific xclbin to be download on devices of U30 card
     ...
     - setup.sh: script to set up build time as well as runtime environment variables for I

#. Install GStreamer version 1.16.2::
    
    source ./install_gst.sh
    
#. Install IVAS plugins and applications ::
Execute the command mentioned below.

    source install_ivas.sh
    
Command clones the IVAS source code, compiles & installs all IVAS GStreamer plugins & sample applications required for AWS. Like open source GStreamer installation, all IVAS binaries will be installed in /opt/xilinx/ivas folder.
...
This page contains instructions on how to download the U30 Video SDK packages and install them on the supported Operating Systems:
