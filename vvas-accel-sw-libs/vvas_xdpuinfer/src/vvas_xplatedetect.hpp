...
class vvas_xplatedetect:public vvas_xdpumodel
{

  int log_level = 0;
  std::unique_ptr < vitis::ai::PlateDetect > model;

public:

  vvas_xplatedetect (vvas_xkpriv * kpriv, const std::string & model_name,
