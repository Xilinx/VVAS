...
class vvas_xclassification:public vvas_xdpumodel
{
  int log_level = 0;
  std::unique_ptr < vitis::ai::Classification > model;

public:
  vvas_xclassification (vvas_xkpriv * kpriv, const std::string & model_name,
