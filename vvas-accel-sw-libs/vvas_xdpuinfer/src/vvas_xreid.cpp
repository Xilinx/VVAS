...
vvas_xreid::vvas_xreid (vvas_xkpriv * kpriv, const std::string & model_name,
...
int
vvas_xreid::run (vvas_xkpriv * kpriv, std::vector<cv::Mat>& images,
...
int
vvas_xreid::requiredheight (void)
{
  LOG_MESSAGE (LOG_LEVEL_DEBUG, log_level, "enter");
...
int
vvas_xreid::supportedbatchsz (void)
{
  LOG_MESSAGE (LOG_LEVEL_DEBUG, log_level, "enter");
...
int
vvas_xreid::close (void)
{
  LOG_MESSAGE (LOG_LEVEL_DEBUG, log_level, "enter");
  return true;
}

vvas_xreid::~vvas_xreid ()
{
  LOG_MESSAGE (LOG_LEVEL_DEBUG, log_level, "enter");
}
