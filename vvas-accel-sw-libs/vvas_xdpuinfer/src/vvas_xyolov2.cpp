...
vvas_xyolov2::vvas_xyolov2 (vvas_xkpriv * kpriv, const std::string & model_name,
    bool need_preprocess)
{
  ...
  model = vitis::ai::YOLOv2::create (model_name, need_preprocess);
}

bool compare_by_area (const vitis::ai::YOLOv2Result::BoundingBox &box1,
    const vitis::ai::YOLOv2Result::BoundingBox &box2)
{
...
int
vvas_xyolov2::run (vvas_xkpriv * kpriv, std::vector<cv::Mat>& images,
...
int
vvas_xyolov2::requiredwidth (void)
{
...
int
vvas_xyolov2::requiredheight (void)
{
  LOG_MESSAGE (LOG_LEVEL_DEBUG, log_level, "enter");
...
int
vvas_xyolov2::supportedbatchsz (void)
{
  LOG_MESSAGE (LOG_LEVEL_DEBUG, log_level, "enter");
...
int
vvas_xyolov2::close (void)
{
  LOG_MESSAGE (LOG_LEVEL_DEBUG, log_level, "enter");
  return true;
}

vvas_xyolov2::~vvas_xyolov2 ()
{
  LOG_MESSAGE (LOG_LEVEL_DEBUG, log_level, "enter");
}
