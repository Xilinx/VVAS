...
vvas_xrefinedet::vvas_xrefinedet (vvas_xkpriv * kpriv,
...
bool compare_by_area (const vitis::ai::RefineDetResult::BoundingBox &box1, const vitis::ai::RefineDetResult::BoundingBox &box2)
{
...
int
vvas_xrefinedet::run (vvas_xkpriv * kpriv, std::vector<cv::Mat>& images,
...
int
vvas_xrefinedet::requiredwidth (void)
{
...
int
vvas_xrefinedet::requiredheight (void)
{
  LOG_MESSAGE (LOG_LEVEL_DEBUG, log_level, "enter");
...
int
vvas_xrefinedet::supportedbatchsz (void)
{
  LOG_MESSAGE (LOG_LEVEL_DEBUG, log_level, "enter");
...
int
vvas_xrefinedet::close (void)
{
  LOG_MESSAGE (LOG_LEVEL_DEBUG, log_level, "enter");
  return true;
}

vvas_xrefinedet::~vvas_xrefinedet ()
{
  LOG_MESSAGE (LOG_LEVEL_DEBUG, log_level, "enter");
}
