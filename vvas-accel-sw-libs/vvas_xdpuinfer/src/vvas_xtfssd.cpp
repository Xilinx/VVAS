...
vvas_xtfssd::vvas_xtfssd (vvas_xkpriv * kpriv, const std::string & model_name,
    bool need_preprocess)
{
  ...
  model = vitis::ai::TFSSD::create (model_name, need_preprocess);
}

bool compare_by_area (const vitis::ai::TFSSDResult::BoundingBox &box1, const vitis::ai::TFSSDResult::BoundingBox &box2)
{
...
int
vvas_xtfssd::run (vvas_xkpriv * kpriv, std::vector<cv::Mat>& images,
...
int
vvas_xtfssd::requiredwidth (void)
{
...
int
vvas_xtfssd::requiredheight (void)
{
  LOG_MESSAGE (LOG_LEVEL_DEBUG, log_level, "enter");
...
int
vvas_xtfssd::supportedbatchsz (void)
{
  LOG_MESSAGE (LOG_LEVEL_DEBUG, log_level, "enter");
...
int
vvas_xtfssd::close (void)
{
  LOG_MESSAGE (LOG_LEVEL_DEBUG, log_level, "enter");
  return true;
}

vvas_xtfssd::~vvas_xtfssd ()
{
  LOG_MESSAGE (LOG_LEVEL_DEBUG, log_level, "enter");
}
