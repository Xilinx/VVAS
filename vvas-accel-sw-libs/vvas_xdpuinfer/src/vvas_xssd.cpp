...
vvas_xssd::vvas_xssd (vvas_xkpriv * kpriv, const std::string & model_name,
...
bool compare_by_area (const vitis::ai::SSDResult::BoundingBox &box1, const vitis::ai::SSDResult::BoundingBox &box2)
{
...
int
vvas_xssd::run (vvas_xkpriv * kpriv, std::vector<cv::Mat>& images,
...
int
vvas_xssd::supportedbatchsz (void)
{
  LOG_MESSAGE (LOG_LEVEL_DEBUG, log_level, "enter");
